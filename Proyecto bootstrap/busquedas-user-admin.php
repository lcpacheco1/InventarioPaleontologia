						...
						<nav class="navbar barra-navegacion">
							...
							<div class="collapse navbar-collapse cl-effect-13" id="bs-example-navbar-collapse-1">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<li>
										<a href="user_reg.php?ced=<?php echo $cedulaa ?> #audios" class="scroll">Audios</a>
									</li>
									<li>
										<a href="user_reg.php?ced=<?php echo $cedulaa ?> #cargar-audio" class="scroll">Cargar</a>
									</li>
									<li>
									...
									<li>
										<a href="admin.php?ced=<?php echo $cedulaa ?> #usuarios" class="">Gestionar</a>
									</li>
								</ul>
