...
<body>
	...
	<div class="audios">
		<div class="container">
			<h3 class="titulo-seccion">Juegos</h3>
			<div class="row">
				<div class="Caja-audios">
					<?php
						...
						?>
							...
							echo "<a class='icon-thumb_up like'><span>".$audio['likes']."</span></a><a class='icon-insert_comment coment'><span>".$cont."</span></a></div><div class='back'><img src='data:image/jpg;base64, ".base64_encode($audio['portada'])."'></div><a  href = 'audio_r.php?id2=$audio[0]&ced=$cedula&autoplay=true' class='icon-play_circle_outline repro'><span>Jugar</span></a></div>";
					}
					?>
				</div>
			</div>
