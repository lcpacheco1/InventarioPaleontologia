...
<body>
						...
						<nav class="navbar barra-navegacion">
							...
							<div class="collapse navbar-collapse cl-effect-13" id="bs-example-navbar-collapse-1">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<li>
										<a href="user_reg.php?ced=<?php echo $cedula ?> #audios" class="">Audios</a>
									</li>
									<li>
										<a href="user_reg.php?ced=<?php echo $cedula ?> #cargar-audio" class="">Cargar</a>
									</li>
									<li>
										<a href="#home" class="">Categorias</a>
									</li>
									<li>
	...
	<div class="audios" id="audios">
		<div class="container">
			<?php
				$listcategorias = $conexion->query("SELECT idCategoria, categoria FROM categoria ORDER BY idCategoria");
				while ($categoria=$listcategorias->fetch(PDO::FETCH_BOTH)){
					echo "<h3 class='titulo-seccion'>".$categoria['categoria']."</h3>";
					?>
					<div class="row">
				<div class="Caja-audios">
					<?php
						$listAudios=$conexion->query("SELECT idAudio, titulo, autor, descripcion, audio, portada, likes, dislikes FROM audio WHERE $categoria[0] = Categoria_idCategoria ORDER BY idAudio");

								while ($audio=$listAudios->fetch(PDO::FETCH_BOTH)){
									echo "<div class='box-audio'><div class='listaud'>
									<a class='tituloAud' href='audio.php?id2=$audio[0]&autoplay=false'>".$audio['titulo']."</a>
						...
						?>
							...
							echo "<a class='icon-thumb_up like'><span>".$audio['likes']."</span></a><a class='icon-insert_comment coment'><span>".$cont."</span></a></div><div class='back'><img src='data:image/jpg;base64, ".base64_encode($audio['portada'])."'></div><a  href = 'audio.php?id2=$audio[0]&autoplay=true' class='icon-play_circle_outline repro'><span>Reproducir</span></a></div>";
					}
					?>
				</div>
			</div>
					...
					<div class="col-md-4 cuadro-datos">
						<div class="dato vista-principal ab3">
							<div class="caja-texto">
								...
								<p class="paragraph-w3l">Programadora y con un enorme deseo de aprender tecnología actuales, en auge.</p>
							</div>
							<div class="mask ab3">
								<br> 
								<h3>Informacion de contacto</h3>
