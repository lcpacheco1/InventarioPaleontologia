...
<body>
						...
						<nav class="navbar barra-navegacion">
							...
							<div class="collapse navbar-collapse cl-effect-13" id="bs-example-navbar-collapse-1">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<li>
										<a href="juegos.php" class="">Juegos</a>
									</li>
									<li>
	...
	<div class="audios">
		<div class="container">
			<div class="row">
				<div class="Caja-aud" id="categoria">
					<?php					
						...
						$listAudios=$conexion->query("SELECT idAudio, titulo, autor, descripcion, audio, portada, likes, dislikes FROM audio WHERE idAudio = $id_registro");
								...
								while ($audio=$listAudios->fetch(PDO::FETCH_ASSOC)){
									...
									echo '<a class="icon-thumb_up like"><span>'.$audio['likes'].'</span></a><a class="icon-insert_comment coment"><span>'.$cont.'</span></a></div><div class="caja-reproductor"><audio controls="controls" class="reproductor" '.$play.'><source src="data:audio/mp3;base64,'.base64_encode($audio['audio']).'"></audio controls></div>';
