...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-02-2019 a las 23:34:00
...
INSERT INTO `coleccion` (`idColeccion`, `nombre`, `propietario`, `control`, `curador`) VALUES
(1, 'Municipio de Yantzaza', 'Municipio de Yantzaza', 'ÑVIE-001,27', 'Al que asigne el municipio');
...
INSERT INTO `localizacion` (`idLocalizacion`, `calle`, `numero`, `UTMeste`, `UTMnorte`, `Parroquia_idParroquia`) VALUES
(1, 'Avenida Iván Riofrío', 1, 748865, 9575616, 2);
...
INSERT INTO `proyecto` (`idProyecto`, `nombre`, `era`, `periodo`, `epoca`, `cronologia`) VALUES
(1, 'Estudio Geológico-Paleontológico', 'Mesozoico', 'Cretácico', 'Cretácico inferior', 'Relativa');
...
(3, 1111111111, 'Amanda', 'Tacuri Jaramillo', 'chiojaramillo2@gmail.com', 'mary12345', 'Usuario');
...
--
ALTER TABLE `coleccion`
  MODIFY `idColeccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `localizacion`
  MODIFY `idLocalizacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
