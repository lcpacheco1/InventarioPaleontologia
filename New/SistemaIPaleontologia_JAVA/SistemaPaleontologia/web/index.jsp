<%-- 
    Document   : index
    Created on : 01-feb-2019, 2:06:16
    Author     : Rocio
--%>
        ...
        <div class="login-body">
          <form method="post" action="login">
            ...
            <div class="form-group">
              ...
              <input class="form-control" name="txtContrasenia" type="password" placeholder="Password" required>
              <!--<input class="form-control" name="txtCedula" type="text" >-->
            </div>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item">
        <img class="d-block w-100" src="Templates/images/fosil2.JPG" alt="First slide">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="Templates/images/fosil3.JPG" alt="Second slide">
        <div class="carousel-caption d-none d-md-block">
          <h2 class="font-weight-bold">ALGUNOS FÓSILES MÁS <span class="text-naranja">REPRESENTATIVOS</span></h2>
          <div class="d-md-none d-lg-block">
      ...
      <div class="carousel-item active">
        <img class="d-block w-100" src="Templates/images/fosil1.jpg" alt="Third slide">
        <div class="carousel-caption d-none d-md-block">
          <h2 class="font-weight-bold">ALGUNOS FÓSILES MÁS <span class="text-naranja">REPRESENTATIVOS</span></h2>
          <div class="d-md-none d-lg-block">
      ...
      <div class="row">
        <div class="col-md-4 text-center">
          <div class="intro-block py-5 px-4 bg-light">
            <img src="Templates/images/fosil2.JPG" class="img-fosil mb-4" alt="fosil 1">
            <h3>RANAS</h3>
        ...
        <div class="col-md-4 text-center">
          <div class="intro-block py-5 px-4 bg-light">
            <img src="Templates/images/fosil1.jpg" class="img-fosil mb-4" alt="fosil 2">
            <h3>SERPIENTE</h3>
        ...
        <div class="col-md-4 text-center">
          <div class="intro-block py-5 px-4 bg-light">
            <img src="Templates/images/fosil3.JPG" class="img-fosil mb-4" alt="fosil 2">
            <h3>NOCHNITSA</h3>
              ...
              <div class="carousel-item active">
                <div class="item active text-center">
                  <div class="border-team rounded-circle bg-celeste">
                    <img src="Templates/images/Kayla.jpg" alt="Imagen 1" class="img-team rounded-circle">
                  </div>
