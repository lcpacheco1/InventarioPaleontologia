<%-- 
    Document   : AdminReg
    Created on : 07-feb-2019, 9:54:21
    Author     : Rocio
--%>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item text-color-menu">
                                <a class="nav-link navv" id="color" href="#contactos">Gestinar usuarios</a>
                            </li>
                            <li class="nav-item text-color-menu">
                                <a class="nav-link navv" id="color" href="#fichas">Gestinar fichas</a>
                            </li>
                            <li>
                                <%
